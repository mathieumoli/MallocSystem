 ...
 */
 ...
 //	printf("je passe dans un second implement\n" );
	...
	//*************************************
	//printf("je suis pas passé par le freelist\n");
	// il n'y a pas encore de free ou pas de place assez grande
	//recuperation de l'adresse du break du tas
	// nouvelleAdresse=sbrk(0);
 	
	//ici ça fonctionne
	// //s'il n'y a plus de place sbrk retourne -1
	// if(sbrk(size+HEADER_SIZE) ==((void*)-1)){
	// 	// on renvoit un NULL
	// 	return NULL;
	// }
	...
	// //calcul de l'adresse pointer après la métadonnée
	// adresseSansMeta=nouvelleAdresse+HEADER_SIZE;
	// return adresseSansMeta;
 }
